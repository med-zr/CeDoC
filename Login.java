package cedocpackage;
	...
	private void initialize() {
		...
		frame.getContentPane().setBackground(new Color(113,159,228));
		...
		lblNewLabel_2.setFont(new Font("Vladimir Script", Font.BOLD, 55));
                lblNewLabel_2.setIcon(new ImageIcon("img/cedoc_img.jpg"));
		lblNewLabel_2.setForeground(Color.WHITE);
		lblNewLabel_2.setBounds(0, 6, 786,150 );
		...
		//lblNewLabel_4.setIcon(new ImageIcon("img/library.jpg"));
                lblNewLabel_4.setBackground(new Color(113,159,228));
