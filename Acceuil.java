package cedocpackage;
	...
	public JPanel welcome,suivie_panel,suivie_panel1,avancements_panel,avancements_panel1,taches_panel,taches_panel1,FAQ_panel,FAQ_panel1;
        ...
        private JButton changer_photo,chercher_nom_affect,full_list,reserver,mes_reservations;
	...
	public Boolean isaccepted(int id){
        ...
        public int getEncadrantID(int id){
            try{
                String sql = "SELECT info_enseignant.id FROM info_enseignant join info_etudiant ON info_etudiant.id_encadrant=info_enseignant.id where info_etudiant.id=?";
                PreparedStatement stm = connection.prepareStatement(sql);
                stm.setInt(1,id);
                ResultSet rst = stm.executeQuery();
	...
	public void acceuil(int id) {
		...
		//panel_2.setBackground(new Color(246, 126, 214));
                panel_2.setBackground(new Color(128,128,128));
		panel_2.setBounds(0, 117, 218, 545);
		panel_2.setLayout(null);
		
		panel_3 = new JPanel();
		//panel_3.setBackground(new Color(246, 126, 214));
		...
		//panel_3_1.setBackground(new Color(246, 126, 214));
		...
		//panel_3_1_1.setBackground(new Color(246, 126, 214));
		...
		panel_4 = new JPanel();
		//panel_4.setBackground(new Color(246, 126, 214));
		...
		//panel_11.setBackground(new Color(246, 126, 214));
		...
		//panel_1.setBackground(new Color(246, 126, 214));
		...
		panel_6 = new JPanel();
		//panel_6.setBackground(new Color(246, 126, 214));
		...
		panel_10 = new JPanel();
		//panel_10.setBackground(new Color(246, 126, 214));
		...
		/*profile panel*/{
                        ...
                        changer_photo.addActionListener(new ActionListener(){
                            public void actionPerformed(ActionEvent e){
                                ...
                                if (showOpenDialogue == JFileChooser.APPROVE_OPTION) {
                                    ...
                                    Image image = ii.getImage().getScaledInstance(student.getWidth(), student.getHeight(), Image.SCALE_SMOOTH);
                                    student.setIcon(new ImageIcon(image));
                                    try{
			...
			submit_panel.add(submit_label);
                ...
                /*suivi panel*/{
                    ...
                    try {
                        String sql="SELECT info_etudiant.nom,info_etudiant.prenom,info_enseignant.nom,info_enseignant.prenom FROM info_etudiant JOIN info_enseignant ON info_etudiant.id_encadrant=info_enseignant.id";
                    ...
                    chercher_nom_affect.addActionListener(new ActionListener(){
                            public void actionPerformed(ActionEvent e) {
                                ...
                                try {
                                    String sql="SELECT info_etudiant.nom,info_etudiant.prenom,info_enseignant.nom,info_enseignant.prenom FROM info_etudiant JOIN info_enseignant ON info_etudiant.id_encadrant=info_enseignant.id WHERE info_etudiant.id=?";
                                    PreparedStatement pstm = connection.prepareStatement(sql);
                    ...
                    ajouter_avancement_label.addMouseListener(new MouseAdapter(){
                        ...
                        public void mouseClicked(MouseEvent e){
                            try{
                                ...
                                PreparedStatement pstm = connection.prepareStatement("SELECT info_etudiant.nom,info_etudiant.prenom,info_enseignant.nom FROM info_etudiant JOIN info_enseignant ON info_etudiant.id_encadrant=info_enseignant.id WHERE info_etudiant.id=?");
                                pstm.setInt(1,id);
                                ResultSet Rs = pstm.executeQuery();
                                Rs.next();
                ...
                /*contact panel*/ {
                    ...
                    envoyer.addActionListener(new ActionListener(){
                        ...
                        Session session = Session.getDefaultInstance(properties,new Authenticator(){
                            ...
                            protected PasswordAuthentication getPasswordAuthentication(){
                                return new PasswordAuthentication(getEmail(id),"ZAHAR@_20@20_19");
                            }
                        });
                        try {
                            MimeMessage message1 = new MimeMessage(session);
                            message1.setFrom(new InternetAddress(getEmail(id)));
                            message1.addRecipient(Message.RecipientType.TO,new InternetAddress("cedoc.trial@gmail.com") );
                    ...
                    deposer = new JButton("Dépôt");
                    deposer.setBounds(265,480,200,50);
                    deposer.setFont(new Font("Arial", Font.BOLD, 15));
                }
                /*taches panel*/{
                ...
                /*labo panel*/{
                    ...
                    reserver.addActionListener(new ActionListener(){
                        public void actionPerformed(ActionEvent e){
                            ...
                            if(a_reserver(id,model3.getValueAt(i,1).toString())==false){
		...
		panel_3_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				panel_7.setVisible(true);
				/*panel_3.setBackground(new Color(246, 126, 214));
				panel_3_1.setBackground(new Color(255,153,204));
				panel_3_1_1.setBackground(new Color(246, 126, 214));
				panel_11.setBackground(new Color(246, 126, 214));
				panel_4.setBackground(new Color(246, 126, 214));
				panel_10.setBackground(new Color(246, 126, 214));*/
		...
		panel_11.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				panel_3_1.setBackground(new Color(246, 126, 214));
				panel_3_1_1.setBackground(new Color(246,126,214));
				panel_11.setBackground(new Color(255,153,204));
				panel_4.setBackground(new Color(246, 126, 214));
				panel_10.setBackground(new Color(246, 126, 214));*/
                                panel_7.setBackground(new Color(232, 230, 241));
                                welcome.setBackground(new Color(232, 230, 241));
		...
		panel_10.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				panel_11.setBackground(new Color(246, 126, 214));
				panel_4.setBackground(new Color(246, 126, 214));
				panel_10.setBackground(new Color(255,153,204));*/
